...
The implementation and guideline for Saiency Map-aided GAN for RAW2RGB Mapping.
...
Our model is superior to general Pix2Pix model and there is no BN artifacts.
