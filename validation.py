...
def comparison(root, colornet):
    ...
    real = img.crop((0, 0, 224, 224))
    real = real.resize((224, 224), Image.ANTIALIAS)
    real = np.array(real)
    # Forward propagation
...
if __name__ == "__main__":
    ...
    parser.add_argument('--baseroot', type = str, default = './ValidationPhoneRaw', help = 'validation images baseroot')
    parser.add_argument('--saveroot', type = str, default = './ValidationResults', help = 'result images saveroot')
